...
const io = new Server(server, {
  cors: {
    origin: process.env.FRONTEND_URL || 'https://collabhub-frontend.vercel.app',
    credentials: true
  }
});
...
// Middleware
app.use(helmet());
app.use(cors({ origin: process.env.FRONTEND_URL || 'https://collabhub-frontend.vercel.app', credentials: true }));
